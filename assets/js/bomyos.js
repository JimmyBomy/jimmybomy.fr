...
const PROJECTS={
  amitie:{name:"Amitié Artisan",cat:"Client · site en développement",grad:"linear-gradient(135deg,#3a1e12,#c8892e 52%,#a7d98a)",role:"Conception & développement du site",year:"2026",client:"Amitié Artisan — client réel (en cours)",tags:["Client","Web","Réseau d'artisans","En développement"],link:"",desc:"Projet client en cours : le site d'Amitié Artisan (amitie-artisan.com), un réseau d'artisans et de producteurs locaux — présentation du réseau, annuaire des membres et mise en avant des savoir-faire. Conception et développement en cours, mise en ligne à venir."},
