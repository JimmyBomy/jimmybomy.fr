...
const PROJECTS={
  boulangerie:{name:"La Fournée de Sedan",cat:"Démo — site de commerce",img:"assets/shots/boulangerie.jpg",grad:"linear-gradient(135deg,#8a5a1c,#c8892e 55%,#f2d06b)",role:"Exemple pour commerçants & indépendants",year:"2026",client:"Démonstration",tags:["Site vitrine","Click & Collect","Responsive","Fait main"],link:"https://jimmybomy.fr/projets/demo-boulangerie/",desc:"👉 Un exemple concret de ce que VOTRE commerce pourrait avoir : site vitrine appétissant, click & collect interactif, horaires, avis clients, plan d'accès. La boulangerie est fictive — mais votre site pourrait ressembler à ça, et démarrer par une maquette gratuite."},
...
function content(app){
  ...
  if(app==="services")return `<div class="h-eyebrow">Pour les commerces & indépendants</div><div class="h-title">Un site pro,<br>sans prise de tête.</div>
    ...
    <button class="btn" data-site="https://jimmybomy.fr/projets/demo-boulangerie/" data-title="Exemple — La Fournée de Sedan" style="margin-top:18px">👀 Voir un exemple de site (boulangerie)</button>
